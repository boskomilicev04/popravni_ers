...
namespace Autoservis.Services
{
    ...
    {
        private readonly IVoziloRepository _repo;
        private readonly IObracunServis _obracun;
        private readonly IRacunRepository _racunRepo;
        private readonly IEvidencijaServis _logger;

        public VoziloService(IObracunServis obracun, IEvidencijaServis logger, IVoziloRepository repo, IRacunRepository racunRepo)
        {
            _obracun = obracun;
            _logger = logger;
            _repo = repo;
